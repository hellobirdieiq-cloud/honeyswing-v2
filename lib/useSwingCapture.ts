...
import { useWatchImuCapture, type VideoAlignAnchor } from './useWatchImuCapture';
 ...
 */
interface CaptureProcessingContext {
 ...
 */
async function processRecordedVideo(video: VideoFile, ctx: CaptureProcessingContext): Promise<void> {
  const {
    videoUriRef,
    videoOutboxEntryIdRef,
    swingIdPromiseRef,
